...
| **D5** | The blueprint's only provenance pointer referenced `~/Desktop/rag-training/raw/…` — a directory that exists but is **empty**. | Corrected to `../tasks/` in [`../../README.md`](../../README.md). |
